...
public class AliPay implements IPay<AliPayInfo> {

    private static final int SDK_PAY_FLAG = 6406;
    private Activity mActivity;
    private AliPayInfo alipayInfoImpli;
    private static Pay.IPayCallback sPayCallback;

    @Override
    public void pay(Activity activity, AliPayInfo payInfo, Pay.IPayCallback payCallback) {
